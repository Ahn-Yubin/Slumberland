...
public class Collision {
	...
	public void setMinimumTranslationVector(Vector translationVector1) {
		this.minimumTranslationVector = translationVector1;
	}
	...
	public static Collision collisionTest(Collider col1, Collider col2) {
		...
		return new Collision(true, axisWhenR0IsMin.mul(minimumR0)); // the direction of MTV is from col2 to col1 
	}
}