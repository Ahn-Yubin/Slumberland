...
public class BossHPBarGUI extends GUI {	
	...
	public BossHPBarGUI(double guiWidth, double guiHeight) {
	...
	public void updateUiImage(Model model) {
		if(!model.getEnemyList().isEmpty()) {
			double currentHP = model.getEnemyList().get(0).getHp();
			...
			int Barratio = 40;
			double hpPerBar = model.getEnemyList().get(0).getMaxHP() / Barratio;
			...
			this.tmpBuffG.setColor(Color.RED);
