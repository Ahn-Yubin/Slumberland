...
public class Controller implements KeyListener, MouseListener, Runnable{
	...
	/*
	public void collisionFinal(PhysicalObject obj1, PhysicalObject obj2) {
		Collision coll = Collision.collisionTest(obj1.getCollider(), obj2.getCollider());
		if(coll.isCollision()) {
			obj1.whenCollision(obj2);
			obj2.whenCollision(obj1);
		}
	}
	*/
