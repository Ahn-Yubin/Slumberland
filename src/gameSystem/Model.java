...
public class Model {
	...
	public Model() {
		...
		this.setBackground(new Drawable(backgroundInitialPosition, 8000, 2500,
				Toolkit.getDefaultToolkit().getImage("res/img/drawable/background.png"), 1, new Vector(1, 0)));
	}
