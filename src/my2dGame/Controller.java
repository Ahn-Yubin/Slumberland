	...
	public void run() { // Controller's Thread
		...
		try {
			while(true) {
				...
				System.out.println(model.getStageName() + " " + model.getGameState());
				...
				//System.out.println(model.getPlayer().getPosition().sub(model.getPlayerInitialPosition()) + " " + model.getBackgroundInitialPosition() + " " + model.getBackground().getPosition());
