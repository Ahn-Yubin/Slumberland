...
public class Model {
	...
	private String gameState; // Running, GameOver, Clear
	...
	public Model() {
		...
		this.backgroundInitialPosition = new Vector(6500, 3550);
		this.setBackground(new Drawable(backgroundInitialPosition, 8000, 2500, Toolkit.getDefaultToolkit().getImage("res/img/background.png"), 1, new Vector(1, 0)));
	}

	public void initializeFirstStage() {
		this.setStartTime(System.currentTimeMillis());
		this.setGameState("Running");
		this.setStageName("firstStage");

		this.player = new Player();
		this.playerInitialPosition = new Vector(2500, 2000);
		...
		System.out.println(this.background.getPosition());
	...
	public void bossStage() {
		this.setGameState("Running");
		this.setStageName("bossStage");

		this.playerInitialPosition = new Vector(4500, 3318).add(new Vector(0, 400));
	...
	public void setGameState(String stageTitle) {
		this.gameState = stageTitle;
	}
