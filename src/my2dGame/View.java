...
public class View extends JPanel implements Runnable {
	...
	public void paintComponent(Graphics g) {
		...
		if (model.getGameState().equals("GameOver")) {
			...
			buffG.drawString("당신은 죽었습니다.", resolutionWidth / 2 - 250 - 31, resolutionHeight / 2 - 20);
			buffG.setColor(new Color(200, 200, 200));
			buffG.setFont(font.deriveFont(40.f));
			buffG.drawString("PRESS R TO RESTART", resolutionWidth / 2 - 250 + 100 + 40 - 15, resolutionHeight / 2 + 70 - 20);
			buffG.drawString("PRESS ESC TO EXIT", resolutionWidth / 2 - 250 + 180 - 30 + 5 - 17, resolutionHeight / 2 + 137 - 20);
		}
			...
			buffG.drawString("클리어 타임 : " + minute + ":" + second, resolutionWidth / 2 - 250 + 100 + 40 - 30, resolutionHeight / 2 + 70 - 20);
			//buffG.drawString("클리어 타임 : " + 7 + ":" + 12.123, resolutionWidth / 2 - 250 + 100 + 40 - 30, resolutionHeight / 2 + 70 - 20);
			buffG.drawString("PRESS ESC TO EXIT", resolutionWidth / 2 - 250 + 180 - 30 + 5 - 17 - 4 - 7, resolutionHeight / 2 + 137 - 20);
		}
